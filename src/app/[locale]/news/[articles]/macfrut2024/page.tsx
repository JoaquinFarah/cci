    ...
    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
        ...
        <div className="space-y-6">
          <p>
          La Facultad de Ciencias Económicas de la Universidad Nacional de Cuyo fue el epicentro de un intenso análisis sobre la economía nacional y provincial durante las Jornadas Económicas celebradas los días 28, 29 y 30 de agosto. Este evento, que contó con el patrocinio de la Cámara de Comercio Italiana de Mendoza, reunió a más de 500 asistentes, incluidos empresarios, académicos y estudiantes, quienes tuvieron la oportunidad de escuchar a expertos de renombre sobre los desafíos y oportunidades del panorama económico actual.
          </p>

          <p className="font-bold text-xl">
          Apertura y primeras disertaciones
          </p>
          ...
          <p>
          El primer panel del evento fue un éxito contundente, con la participación de representantes de Globant, PWC, Valvtronic y el Gobierno de Mendoza. En él, se discutió el impacto de la inteligencia artificial, la programación y el manejo del inglés como competencias clave para el mercado laboral del futuro, enfatizando la permanencia del trabajo híbrido y la importancia de la resiliencia y la adaptabilidad en el ámbito profesional.
          </p> 

          <p className="font-bold text-xl">
          Paneles destacados sobre la economía argentina
          </p>
          ...
          <p className="font-bold text-xl">
          Clausura: el futuro del mercado de capitales
          </p>
          ...
          <p className="font-bold text-xl">
          Reconocimiento a la Cámara de Comercio Italiana de Mendoza
          </p>

          <p>
          La participación de la Cámara de Comercio Italiana de Mendoza en estas jornadas refuerza su compromiso con el desarrollo económico de la provincia y el fortalecimiento de las relaciones entre Italia y Argentina. Como sponsor, la Cámara apoyó la organización del evento y brindó una plataforma para que sus socios y colaboradores se conectaran con líderes del pensamiento económico, ampliando su visión sobre el futuro económico de Mendoza y del país.
          </p>

          <p className="font-bold text-xl">
          Networking y nuevas oportunidades de negocio
          </p>
