...
export default function Calendar() {
  const events = [   
    ...
    { 
      ...
      color: 'green',
      description: 'del 08 al 10 de Mayo',
      footer: '<a href="/">Link a la noticia</a>' 
  ...
  const handleEventClick = (clickInfo) => {
    Swal.fire({
      ...
      html: clickInfo.event.extendedProps.description,
