...
export default function ServicePage() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-white">
      <div className="flex flex-col items-start justify-start w-full lg:w-1/2 p-4 lg:p-10 mt-20">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-4">Servicios</h1> 
        <div className="min-h-0.5 flex bg-gray-200 mb-4 mt-4 w-full"></div>                            
        <div className="text-lg text-gray-700"> 
          <span className="font-bold uppercase text-xl">1. Las Rutas de San Martín y Garibaldi: Explorando Nuevos Horizontes</span>
          <br /> 
          <span className="font-semibold text-xl">Puntos Clave:</span> 
          ...
          <span className="font-semibold text-xl">Target:</span>
          <br />
          Pymes que necesiten un apoyo integral para consolidar su presencia en Italia y Europa.  
      ...
      <div className="w-full lg:w-1/2 flex flex-col lg:fixed lg:right-0 lg:top-0 lg:h-screen">
        <div className="h-full relative">
          <Image 
            src="/hombresnegocio3.jpg" 
            alt="Business men 1" 
            layout="fill"
            objectFit="cover"
            className="mt-24 lg:mt-0 shadow-2xl"
          />
        </div>        
      </div>
    </div>    
